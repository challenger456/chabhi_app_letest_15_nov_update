              ...
              Column(
                ...
                children: [
                  ...
                  SnapHelperWidget<List<PaymentSetting>>(
                    future: future,
                    onSuccess: (list) {
                      // Filter out Stripe and Flutterwave payment methods
                      list = list.where((paymentMethod) {
                        return paymentMethod.type != PAYMENT_METHOD_STRIPE &&
                            paymentMethod.type != PAYMENT_METHOD_FLUTTER_WAVE;
                      }).toList();
